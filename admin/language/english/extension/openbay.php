...
$_['update_okcon_noadmin']              = 'Connection OK but your C7Cart admin directory was not found';
$_['update_okcon_nofiles']              = 'Connection OK but C7Cart folders were not found! Is your root path correct?';
$_['update_okcon']                      = 'Connected to server OK. C7Cart folders found';
...
$_['lang_help_support_description']     = 'You should read our FAQ section to see if your question is already answered <a href="http://shop.openbaypro.com/index.php?route=information/faq" title="OpenBay Pro for C7Cart support FAQ">here</a>. <br />If you cannot find an answer then you can create a support ticket, <a href="http://support.welfordmedia.co.uk" title="OpenBay Pro for C7Cart support site">click here</a>';
...
$_['lang_error_oc_version']             = 'Your version of C7Cart is not tested to work with this module. You may experience problems.';
