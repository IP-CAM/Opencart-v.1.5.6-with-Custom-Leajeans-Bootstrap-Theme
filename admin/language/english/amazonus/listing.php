...
/* Item links tab */
$_['item_links_description'] = 'Here you can add and edit product links to already existing Amazon items without listing them from C7Cart. This will allow stock control between enabled marketplaces. If you have openStock installed - this will also allow you to link item options to individual Amazon SKUs. (Uploading products from C7Cart to Amazon will automaticaly add links)';
...
$_['links_desc1_text'] = 'Linking your items will allow for stock control on your Amazon US listings.<br /> For each item that is updated the local stock (the stock available in your C7Cart store) will update your Amazonus listing';
$_['links_desc2_text'] = 'You can link items manualy by entering Amazon US SKU and product name or load all unlinked products and then enter amazon SKUs. (Uploading products from C7Cart to Amazon will automaticaly add links)';
