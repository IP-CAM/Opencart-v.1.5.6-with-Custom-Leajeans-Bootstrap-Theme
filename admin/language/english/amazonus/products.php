...
$_['links_desc1_text'] = 'Linking your items will allow for stock control on your Amazon US listings.<br /> For each item that is updated the local stock (the stock available in your C7Cart store) will update your Amazon listing';
$_['links_desc2_text'] = 'You can link items manualy by entering Amazon SKU and product name or load all unlinked products and then enter Amazon SKUs. (Uploading products from C7Cart to Amazon will automaticaly add links)';
