...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_store_region'] = $this->language->get('text_store_region');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['store_locator'] = $this->url->link('extension/storelocator', 'token=' . $this->session->data['token'], 'SSL');	
			$this->data['store_region'] = $this->url->link('extension/storeregion', 'token=' . $this->session->data['token'], 'SSL');			
