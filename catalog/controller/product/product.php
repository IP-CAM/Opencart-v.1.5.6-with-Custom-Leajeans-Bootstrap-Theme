	...
	public function index() { 
		...
		if (isset($this->request->get['path'])) {
			...
			if (count($parts) != 1) {				
				...
				$parts[]= $category_info['category_id'];				
			}
		...
		//exit;
		//$distinct = array();
		//foreach ($product_categories as $category['category_id'] => $val){
			//$distinct = $val;
		//}
		//print_r($distinct);
		...
		$category_parent = $this->model_catalog_category->getCategories($path);
		$categories = array();
		...
		if ($product_info) {
			...
			$this->document->addScript('catalog/view/javascript/jquery/fancybox/jquery.fancybox-1.3.3.pack.js');
			$this->document->addStyle('catalog/view/theme/leajeans/stylesheet/fancybox/jquery.fancybox.css');
			$this->document->addScript('catalog/view/javascript/cloud-zoom.1.0.2.min.js');			
			$this->document->addStyle('catalog/view/theme/leajeans/stylesheet/cloud-zoom.css');									
