...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="buttons">
    <div class="right">
        <?php if($cancel_link){ ?>
            <a href="<?php echo $cancel_link; ?>" class="btn btn-danger" onclick="return confirmCancel();"><?php echo $button_cancel_profile; ?></a>
        <?php } ?>
        <a href="<?php echo $continue; ?>" class="btn btn-danger"><?php echo $button_continue; ?></a>
    </div>
  </div>
