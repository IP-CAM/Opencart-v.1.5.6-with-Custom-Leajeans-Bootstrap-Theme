...
<div id="content"><?php echo $content_top; ?>
  <div class="breadcrumb container clear">
...
<div class="container clearfix content">
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="container">
    ...
    <div class="buttons">
      <div class="right"><?php echo $text_agree; ?>
        ...
        <?php } ?>
        <input type="submit" value="<?php echo $button_continue; ?>" class="btn btn-danger" />
      </div>
    </div>
  </form>
</div>
