...
<div class="col-xs-12 col-sm-4 col-md-4 pull-left" id="latest">
  <div class="box-heading hidden"><?php echo $heading_title; ?></div>
  <div class="box-content">
    <div class="box-product">
		<div id="myCarousel_top" class="carousel-bot slide" data-ride="carousel">
			<!-- Wrapper for slides -->
			...
			<!-- Controls -->
			<a class="left carousel-control" href="#myCarousel_top" data-slide="prev">
				<span class="glyphicon glyphicon-chevron-left"></span>
			</a>
			<a class="right carousel-control" href="#myCarousel_top" data-slide="next">
