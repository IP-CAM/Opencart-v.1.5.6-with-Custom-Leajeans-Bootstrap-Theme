...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="cart-module">
    <div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <input type="submit" value="<?php echo $button_coupon; ?>" class="btn btn-danger" />
      </form>
    </div>
    <div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <input type="submit" value="<?php echo $button_voucher; ?>" class="btn btn-danger" />
      </form>
    </div>
    <div id="reward" class="content" style="display: <?php echo ($next == 'reward' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <input type="submit" value="<?php echo $button_reward; ?>" class="btn btn-danger" />
      </form>
    </div>
    <div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
      ...
      <input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="btn btn-danger" />
    </div>
  </div>
  <?php } ?>
  ...
  <div class="buttons">
    <div class="right"><a href="<?php echo $checkout; ?>" class="btn btn-danger"><?php echo $button_checkout; ?></a></div>
    <div class="center"><a href="<?php echo $continue; ?>" class="btn btn-danger"><?php echo $button_shopping; ?></a></div>
  </div>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html += '  <input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="btn btn-danger" />';	
				<?php } else { ?>
				html += '  <input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="btn btn-danger" disabled="disabled" />';	
				<?php } ?>
