...
<div class="buttons">
  <table>
    <tr>
      <td align="left"></td>
      <td align="right"><a href="<?php echo $confirm; ?>" class="btn btn-danger"><?php echo $button_confirm; ?></a></td>
    </tr>
  </table>
</div>
...
<div class="buttons">
  <table>
    <tr>
      <td align="left"><a href="<?php echo $back; ?>" class="btn btn-danger"><?php echo $button_back; ?></a></td>
      <td align="right"></td>
    </tr>
  </table>
</div>
